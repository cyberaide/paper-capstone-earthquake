...
quakes, were considered. The Log Energy equation (Figure 1) was used for 
...
\begin{figure}[htp]
    \centering
    \includegraphics[width=0.75\columnwidth]{images/Equations/log_energy.png}
    \caption{Log Energy \cite{fox2021earthquake}}
\end{figure}

The Energy Weighting equation (Figure 2) was used to average depth from quakes.

\begin{figure}[htp]
    \centering
    \includegraphics[width=0.75\columnwidth]{images/Equations/Q_bin.png}
    \caption{Energy Weighted \cite{fox2021earthquake}}
\end{figure}

The Multiplicity equation (Figure 3) is used to count the number of 
occurrences of significant earthquakes in a 2 week period. 

\begin{figure}[htp]
    \centering
    \includegraphics[width=0.75\columnwidth]{images/Equations/Multiplicity_bin.png}
    \caption{Multiplicity \cite{fox2021earthquake}}
\end{figure}
...
Grouped faults empirically into 36 families by proximity. #Show picture of groupings. Used 4 different space filling curves to fill in empty spaces to get graph into a 2d structure.
...
\begin{figure}[htp]
    \centering
    \includegraphics[width=0.75\columnwidth]{images/Equations/NSE_equation.png}
    \caption{Nash Sutcliffe Efficiency \cite{fox2021earthquake}}
\end{figure}


The results are presented as the normalized NSE or NNSE. NNSE = 1/(2-NSE)
...
\TODO{Rivanna description is incomplete}
...
\begin{adjustbox}{max width=\textwidth}
    \begin{tabular}{|r|l|l|l|r|r|r|l|r|l|l|l|}
        ...
        \hline
         ...
         Feb 2022   \\
         \hline
         \ref{sec:tcomputer}   & Thomas.A  & i7-8750H & Win11 Pro  & 1 &   ? & ? & \href{https://www.gigabyte.com/Laptop/AERO-15--RTX-20-Series#kf}{NVIDIA GeForce RTX 2070 with Max-Q Design}  & 16GB & 1 & 1 & 2019   \\
         \hline
         \ref{sec:t2computer}   & Thomas.B  & i7-7700HQ &  Win11 Pro &1 & ? & ? &  NVIDIA GeForce GTX 1060  & 16GB & 1 & 1 & 2017   \\
         \hline
